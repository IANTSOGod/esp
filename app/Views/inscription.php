                            ...
                            <div class="inner">
                                <div class="content position-top">
                                    <div class="category-wrap">
                                        <p class="blog-category"><h3>ETAPE 1</h3></p>
                                    </div>
                                    <h5 class="title"><a href="blog-details.html">Obtenir le modèle</a></h5>
                                    <!--ul class="blog-meta">
                                        <li><i class="icon-27"></i>Oct 10, 2024</li>
                                        <li><i class="icon-28"></i>Com 09</li>
                                    </ul-->
                                    <p>Cliquez <a href="assets/inscription.doc" class="blog-category" download><strong>ici</strong></a> pour obtenir le modèle</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="edu-blog blog-style-1">
                            <div class="inner">
                                <div class="content position-top">
                                    ...
                                    <div class="category-wrap">
                                        <p class="blog-category"><h3>ETAPE 2</h3></p>
                                    </div>
                                    <h5 class="title"><a href="blog-details.html">Remplir le modèle</a></h5>
                        ...
                        <div class="edu-blog blog-style-1">
                            <div class="inner">
                                <div class="content position-top">
                                    ...
                                    <div class="category-wrap">
                                        <a href="#" class="blog-category"><h3>ETAPE 3</h3></a>
                                    </div>
                                    <h5 class="title"><a href="blog-details.html">Remise du modèle rempli</a></h5>
                                    
                                    <p>Le modèle rempli est à envoyer à notre adresse mail espbig2@gmail.com ou à déposer à nos bureaux ou ici-></p>
                                </div>
                            </div>
                        </div>
                    </div>
